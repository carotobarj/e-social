...
export default function Alien() {
  return (
    <div><svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-alien" width="20" height="20" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#f0f8ff" fill="none" strokeLinecap="round" strokeLinejoin="round">
